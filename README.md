...
<details>
  ...
  - `https://github.com/erickbxs/Typescript-Trybers-and-Dragons.git`.
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b project-trybers-and-dragons`
  ...
  - Usando o exemplo anterior: `git push -u origin project-trybers-and-dragons`
...
<details>
  ...
  - Vá até a página **DO SEU** _Pull Request_, adicione a label de _"code-review"_ e marque seus colegas:
    ...
    - No menu à direita, clique no _link_ **"Reviewers"** e digite me marque @erickbxs
...
<details>
  ...
  Você sabia que o LinkedIn é a principal rede social profissional e compartilhar o seu aprendizado lá é muito importante para quem deseja construir uma carreira de sucesso? Compartilhe esse projeto no seu LinkedIn, marque o meu perfil @erickbxs e mostre para a sua rede toda a sua evolução.
